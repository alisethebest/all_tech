...
(function (global, factory) {
  ...
  function resume(children, postponedState, options) {
    return new Promise(function (resolve, reject) {
      ...
      var request = createRequest(children, postponedState.resumableState, createRenderState(postponedState.resumableState, options ? options.nonce : undefined, undefined // importMap
      ), postponedState.rootFormatContext, postponedState.progressiveChunkSize, options ? options.onError : undefined, onAllReady, onShellReady, onShellError, onFatalError, options ? options.onPostpone : undefined);
