...
var ReactVersion = '18.3.0-experimental-456d153bb-20230828';
...
function resumeRequestImpl(children, postponedState, options) {
  return createRequest(children, postponedState.resumableState, createRenderState(postponedState.resumableState, options ? options.nonce : undefined, undefined // importMap
  ), postponedState.rootFormatContext, postponedState.progressiveChunkSize, options ? options.onError : undefined, options ? options.onAllReady : undefined, options ? options.onShellReady : undefined, options ? options.onShellError : undefined, undefined, options ? options.onPostpone : undefined);
}
